...
int CountGenap (List L){
    if(IsEmpty(L)){
        ...
        return 1+CountGenap(Tail(L));
    }else{
        return CountGenap(Tail(L));
    }
}
...
int CountKelipatanX(List L, infotype X){
    if(IsEmpty(L)){
        return 0;
    }else if(FirstElmt(L) % X == 0){
        return 1+CountKelipatanX(Tail(L),X);
    }else{
        return CountKelipatanX(Tail(L),X);
    }
}
...
List MakeAllGanjil(List L){
    if(IsEmpty(L)){
        ...
        return Konso(MakeAllGanjil(Tail(L)),FirstElmt(L)+1);
    }else{
        return Konso(MakeAllGanjil(Tail(L)),FirstElmt(L));
    }
}
